...
import { getMedicalRecordsColumns } from './medical-records-columns'
import type { MedicalRecord } from '../api/medical-records'
        ...
        <div className='flex flex-1 flex-col gap-4'>
            <div className='flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between'>
                <div className='flex flex-1 flex-col gap-4'>
                    <DataTableToolbar
                        table={table}
                        searchPlaceholder='Tìm theo mã phiếu, tên hoặc số điện thoại...'
                        filters={[
                            {
                                columnId: 'status',
                                title: 'Trạng thái',
            ...
            <div className='flex flex-col gap-2 rounded-lg bg-card/40 p-4'>
                ...
                <div className='flex flex-col gap-3 border-t pt-4 sm:flex-row sm:items-center sm:justify-between'>
                    <div className='text-sm text-muted-foreground'>
                        Hiển thị {startRow} – {endRow} trên tổng {total} phiếu khám.
                    </div>
